...
const weapons: ScrapedWeapon[] = [
  { name: "AK-74", type: "Automatic Rifles", attachments: [] },
  { name: "M4A1", type: "Automatic Rifles", attachments: [] },
  { name: "AK-15", type: "Automatic Rifles", attachments: [] },
  { name: "SCAR-H", type: "Automatic Rifles", attachments: [] },
  { name: "AUG A3", type: "Automatic Rifles", attachments: [] },
  { name: "SG550", type: "Automatic Rifles", attachments: [] },
  { name: "FAMAS", type: "Automatic Rifles", attachments: [] },
  { name: "ACR", type: "Automatic Rifles", attachments: [] },
  { name: "G36C", type: "Automatic Rifles", attachments: [] },
  { name: "HK419", type: "Automatic Rifles", attachments: [] },
  { name: "FAL", type: "Automatic Rifles", attachments: [] },
  { name: "AK5C", type: "Automatic Rifles", attachments: [] },
